...
# model = YOLO(r'/home/jack/11/1027/YOLO13/yolov13-main/yolov13l.pt') 
model = YOLO(r'/home/jack/11/1027/YOLO13/yolov13-main/ultralytics/cfg/models/11/yolo11-RS.yaml')
model.load(r'/home/jack/11/1027/YOLO13/yolov13-main/yolo11x.pt')
# model = YOLO(r'/home/jack/11/1027/YOLO13/yolov13-main/yolo11x.pt')
...
results = model.train(
    ...
    # name='debug'
    name='yolo11x-RS.yaml_VisDrone-300'
    # workspace=4

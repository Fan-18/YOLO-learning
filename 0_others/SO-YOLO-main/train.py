...
if __name__ == "__main__":
    ...
    #---------------------------------------------------------------------#
    classes_path    = '/home/jack/11/1027/YOLO13/yolov13-main/ultralytics/data/VisDrone/classes.txt'
    #----------------------------------------------------------------------------------------------------------------------------#
    ...
    #------------------------------------------------------------------#
    save_dir            = '/home/jack/11/1027/0_others/SO-YOLO-main/runs/VisDrone_test-SO-YOLO'
    #------------------------------------------------------------------#
    ...
    #------------------------------------------------------#
    train_annotation_path   = '/home/jack/11/1027/YOLO13/yolov13-main/ultralytics/data/VisDrone/train.txt'
    val_annotation_path     = '/home/jack/11/1027/YOLO13/yolov13-main/ultralytics/data/VisDrone/val.txt'
    ...
    if local_rank == 0:
        print(summary(model, (1, 3, *input_shape)))
    ...
    if True:
        ...
        for k, v in model.named_modules():
            if hasattr(v, "bias") and isinstance(v.bias, nn.Parameter):
                pg2.append(v.bias)    
            if isinstance(v, nn.BatchNorm2d) or "bn" in k or isinstance(v, nn.BatchNorm1d):
                pg0.append(v.weight)    
            elif hasattr(v, "weight") and isinstance(v.weight, nn.Parameter):
                pg1.append(v.weight)   
        optimizer = {
            'adam'  : optim.Adam(pg0, min(max(batch_size / nbs * Init_lr, lr_limit_min), lr_limit_max), betas = (momentum, 0.999)),
        ...
        if distributed:
            ...
            # epoch_step = num_samples // batch_size
            val_sampler     = None
            shuffle         = True

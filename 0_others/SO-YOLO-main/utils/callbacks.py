...
class EvalCallback():
    def __init__(self, net, input_shape, class_names, num_classes, val_lines, log_dir, cuda, \
            map_out_path=".temp_map_out", max_boxes=300, confidence=0.01, nms_iou=0.65, letterbox_image=True, MINOVERLAP=0.5, eval_flag=True, period=1):

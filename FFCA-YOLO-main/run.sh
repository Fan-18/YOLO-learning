...
#####  Val  #####
 python val.py --data data/USOD.yaml --weights runs/train_USOD/2_FFCA_YOLO_USOD_1024/weights/best.pt --task val --name FFCA_YOLO_USOD_1024_val --img 1024 --exist-ok 
 python val.py --data data/VisDrone.yaml --weights runs/train_visdrone/1_FFCA_YOLO_VisDrone_1024/weights/best.pt --task val --name FFCA_YOLO_VisDrone_1024_val --img 1024 --exist-ok 
